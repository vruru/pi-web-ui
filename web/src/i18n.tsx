...
export const zh = {
	...
	loading: "加载中…",
	connected: "已连接",
	coreUpdateTitle: "Pi 核心与连接",
	coreUpdateRunningVersion: "当前版本",
	coreUpdateLatestVersion: "最新版本",
	coreUpdateUpdating: "核心更新中…",
	coreUpdateStarting: "正在启动更新…",
	coreUpdateInstalling: "正在下载并安装核心…",
	coreUpdateRestarting: "安装完成，正在重启 Pi 网页服务…",
	coreUpdateSucceeded: "核心更新完成，已成功连接。",
	coreUpdateReconnecting: "正在等待聊天连接恢复…",
	coreUpdateFailed: "核心更新失败。",
	coreUpdateChecking: "正在检查最新稳定版…",
	coreUpdateAvailable: "发现新的核心稳定版本。",
	coreUpdateCurrent: "当前运行核心已是最新稳定版。",
	coreUpdateNotChecked: "尚未检查网上最新稳定版本。",
	coreUpdateCheckFailed: "版本检查失败",
	coreUpdateHint: "更新会重启网页服务。请等待当前任务结束；本页面会自动重新连接。",
	coreUpdateCheckedAt: "上次检查",
	coreUpdateCheck: "检查更新",
	coreUpdateInstall: "更新核心",
	...
	generationRate: "生成速度",
	generationRateTip:
		"输出 token ÷ 首个输出至消息完成的耗时；不含首 token 等待和工具执行。结束后保留本次速度，~ 表示 token 估算，无计时数据时显示 —。",
	hostResources: "主机资源",
	hostProcessor: "CPU",
	hostMemory: "RAM",
	...
	stop: "停止",
	bgTasks: "后台任务",
	bgTasksTip: "管理定时任务、插件后台任务和后台服务",
	bgTasksEmpty: "暂无后台任务",
	bgTasksDesc: "这里显示定时任务、插件后台任务和仍在监听的后台进程",
	bgScheduledHint: "停用或删除只影响后续触发；停止当前执行请进入对应对话。",
	bgTaskStopProcesses: "停止进程与插件任务",
	bgTaskPort: "端口",
	bgTaskPid: "PID",
	bgTaskSince: "启动",
	bgTaskStop: "停止",
...
const en: Record<keyof typeof zh, string> = {
	...
	loading: "Loading…",
	connected: "Connected",
	coreUpdateTitle: "Pi core & connection",
	coreUpdateRunningVersion: "Current version",
	coreUpdateLatestVersion: "Latest version",
	coreUpdateUpdating: "Updating core…",
	coreUpdateStarting: "Starting update…",
	coreUpdateInstalling: "Downloading and installing core…",
	coreUpdateRestarting: "Installed. Restarting Pi web service…",
	coreUpdateSucceeded: "Core updated and connected successfully.",
	coreUpdateReconnecting: "Waiting for the chat connection to recover…",
	coreUpdateFailed: "Core update failed.",
	coreUpdateChecking: "Checking stable release…",
	coreUpdateAvailable: "A new stable core version is available.",
	coreUpdateCurrent: "The running core is up to date.",
	coreUpdateNotChecked: "Latest stable version has not been checked.",
	coreUpdateCheckFailed: "Version check failed",
	coreUpdateHint:
		"Updates restart the web service. Wait for active work to finish; this page reconnects automatically.",
	coreUpdateCheckedAt: "Last checked",
	coreUpdateCheck: "Check for updates",
	coreUpdateInstall: "Update core",
	...
	generationRate: "Generation speed",
	generationRateTip:
		"Output tokens divided by time from first output to message completion; excludes first-token wait and tool execution. Keeps the last speed after completion. ~ means estimated tokens; — means no timing data.",
	...
	bgTasksTip: "Manage scheduled tasks, plugin background tasks and background services",
	bgTasksEmpty: "No background tasks",
	bgTasksDesc:
		"Scheduled tasks, plugin background tasks and background processes still listening on a port appear here",
	bgScheduledHint: "Disabling or deleting affects future triggers only. Open the conversation to stop its current run.",
	bgTaskStopProcesses: "Stop processes and plugin tasks",
	bgTaskPort: "Port",
	bgTaskPid: "PID",
	bgTaskSince: "Started",
	bgTaskStop: "Stop",
	...
	finishedSubagents: "Finished subagents ({n})",
